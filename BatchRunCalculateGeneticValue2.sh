#Usage: bash /home/aiminy/code/code_bash_shell/BatchRunCalculateGeneticValue2.sh wema_16_gbs_plant_height.txt
...
R --slave --args "$f11" "$f12" < ~/CalculateGeneticValue2.R
